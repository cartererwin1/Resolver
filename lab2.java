...
public class lab2 {
  ...
  public static String universals(String[] predicates, ArrayList<String> variables, ArrayList<String> constants, ArrayList<String> functions,
    ...
    File inputFile = new File(args[0]);
      try {
          ...
          for(int i = 1; i < line.length; i++) {
            ...
            System.out.println(universals(predicates, variables, constants, functions, clauses));
